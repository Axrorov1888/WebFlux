...
import uz.developer.repository.StudentRepository;
...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().name(DEFAULT_NAME).surname(DEFAULT_SURNAME);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().name(UPDATED_NAME).surname(UPDATED_SURNAME);
        return student;
    }
    ...
    void putNewStudent() throws Exception {
        ...
        updatedStudent.name(UPDATED_NAME).surname(UPDATED_SURNAME);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.name(UPDATED_NAME).surname(UPDATED_SURNAME);
