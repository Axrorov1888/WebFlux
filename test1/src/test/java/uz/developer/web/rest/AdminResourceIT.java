...
import uz.developer.repository.AdminRepository;
...
class AdminResourceIT {
    ...
    public static Admin createEntity(EntityManager em) {
        Admin admin = new Admin().admin(DEFAULT_ADMIN);
        return admin;
    }
    ...
    public static Admin createUpdatedEntity(EntityManager em) {
        Admin admin = new Admin().admin(UPDATED_ADMIN);
        return admin;
    }
    ...
    void createAdmin() throws Exception {
        ...
        assertThat(testAdmin.getAdmin()).isEqualTo(DEFAULT_ADMIN);
    }
    ...
    void putNewAdmin() throws Exception {
        ...
        updatedAdmin.admin(UPDATED_ADMIN);
        ...
        Admin testAdmin = adminList.get(adminList.size() - 1);
        assertThat(testAdmin.getAdmin()).isEqualTo(UPDATED_ADMIN);
    }
    ...
    void partialUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.admin(UPDATED_ADMIN);
